...
let ReportService = ReportService_1 = class ReportService {
    ...
    async generateScenarioReport(scenarioExecution) {
    ...
    async generateReport(projectId, executionIds, name, description) {
        const executions = [];
    ...
    generateHTML(report, executions) {
...
<body>
    ...
    generateScenarioHTML(report, executions, scenarioExecution) {
        const passRate = report.totalTests > 0
            ? ((report.passedTests / report.totalTests) * 100).toFixed(2)
            : '0.00';
        return `<!DOCTYPE html>
...
<body>
    ...
    renderTestCaseExecution(execution) {
        return `
    <div class="test-case">
