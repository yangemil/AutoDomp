...
function deleteScenarioContext(projectId, scenarioId) {
    const filePath = getScenarioContextPath(projectId, scenarioId);
    if (!fs.existsSync(filePath)) {
        return false;
    }
...
function clearAllScenarioContexts() {
    ensureDirectory();
    if (fs.existsSync(SCENARIO_DIR)) {
